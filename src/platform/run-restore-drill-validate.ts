 ...
 * restored sibling service, never the source. Issues no
 * INSERT/UPDATE/DELETE statements. Prints table row counts and pass/fail
...
async function runRestoreDrillValidate(): Promise<void> {
...
export function runRestoreDrillValidateCli(): void {
  runRestoreDrillValidate().catch((error: unknown) => {
