...
export function generateMembershipContractDocument(): unknown {
  return {
    ...
    googlePlayPreBinding: {
      ...
      publicRoutes: [],
      trustBoundary:
        'Input is trusted only after a future server-side Google Play verifier calls the internal provisioner; no Google API calls and no client-controlled route in this foundation',
