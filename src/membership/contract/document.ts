...
export function generateMembershipContractDocument(): unknown {
  return {
    ...
    googlePlayPreBinding: {
      ...
      publicRoutes: [],
      trustBoundary:
        'Input is trusted only after the server-side Google Play verifier validates the purchase via Android Publisher subscriptionsv2.get and then calls the internal provisioner; no client-controlled route in this foundation',
    ...
    googlePlayVerification: {
      ...
      exclusions: [
        'public Fastify purchase routes',
        'RTDN',
        'Pub/Sub',
    ...
    explicitExclusions: [
      ...
      'JWTs',
      'membership mutation routes exposed to the public',
