...
export function generateAuthenticationCeremonyContractDocument(): unknown {
  return {
    ...
    description:
      'Architecture contract for ceremony data/session foundation, email verification runtime, first-passkey WebAuthn registration runtime, passkey authentication session runtime, and bounded account recovery runtime. Production email delivery, recovery login sessions, membership, and JWTs remain out of scope.',
    ...
    slice:
      'ceremony_data_and_session_foundation_plus_email_verification_webauthn_registration_passkey_authentication_and_account_recovery_runtime',
    domainSeparation: {
    ...
    explicitExclusions: [
      ...
      'second-passkey management outside recovery',
      'passkey deletion',
      'JWTs',
      'membership',
      'Stripe',
