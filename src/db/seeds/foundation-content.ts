...
export const FOUNDATION_SIGNALS = [
  ...
  },
  {
    ...
    description: "Sur le quai des Belges, plusieurs dalles se sont soulevées et forment des différences de niveau sur le cheminement piéton.",
    whyItMatters: "Le Vieux-Port est traversé chaque jour par des habitants, des travailleurs et des visiteurs. Un passage irrégulier augmente le risque de chute.",
    whoIsAffected: "Les personnes âgées, les personnes à mobilité réduite, les parents avec poussette et les piétons.",
    latestUpdate: "Le signalement reste local et ouvert. Aucune intervention confirmée n'est encore annoncée.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
  ...
  },
  {
    ...
    summary: "Le parcours entre le marché et les rues résidentielles est sombre après la fermeture des commerces.",
    description: "Autour de la place des Capucines, plusieurs points lumineux ne fonctionnent plus et la visibilité baisse fortement le soir.",
    whyItMatters: "Un éclairage fiable soutient la sécurité quotidienne d'un quartier dense et très fréquenté.",
    whoIsAffected: "Les habitants de Noailles, les commerçants, les personnes qui rentrent du travail et les usagers des transports.",
  ...
  },
  {
    ...
    description: "À proximité de l'accès public à la plage, les conteneurs débordent régulièrement et des déchets se dispersent vers le littoral.",
    whyItMatters: "La propreté du rivage protège l'environnement marin et maintient un espace public accessible à tous.",
    whoIsAffected: "Les riverains, les familles, les baigneurs, les promeneurs et les associations de protection du littoral.",
  ...
  },
  {
    ...
    description: "Près de la gare Part-Dieu, le balisage du chantier interrompt la piste cyclable sur plusieurs dizaines de mètres.",
    whyItMatters: "Une liaison cyclable discontinue augmente le risque de conflit avec les voitures sur un axe déjà très chargé.",
    whoIsAffected: "Les cyclistes, les usagers de la gare, les livreurs et les automobilistes du quartier.",
    latestUpdate: "Le signalement reste ouvert. Aucun itinéraire cyclable continu n'est encore indiqué.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
    observedOn: '2026-08-08',
  ...
  },
  {
    ...
    description: "Les principaux espaces d'attente de la place Gabriel-Péri ne disposent ni d'arbres matures ni d'abris suffisants.",
    whyItMatters: "Les épisodes de forte chaleur rendent l'espace public difficile à utiliser, surtout pour les personnes vulnérables.",
    whoIsAffected: "Les personnes âgées, les enfants, les voyageurs en correspondance et les habitants du quartier.",
    latestUpdate: "Le signalement ouvre une discussion locale sur des solutions d'ombre temporaires et durables.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
    observedOn: '2026-08-08',
  ...
  },
  {
    ...
    description: "Près du pont Bonaparte, le cheminement vers le quai comporte une rampe irrégulière et difficile à franchir en autonomie.",
    whyItMatters: "Les quais sont un espace public majeur. Leur accès doit être possible sans assistance pour tous les habitants.",
    whoIsAffected: "Les personnes en fauteuil roulant, les personnes avec déambulateur et les familles avec poussette.",
    latestUpdate: "Le signalement reste local et ouvert dans l'attente d'une évaluation d'accessibilité.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
    observedOn: '2026-08-08',
  ...
  },
  {
    ...
    description: "Sur le tronçon proche du port Saint-Sauveur, plusieurs zones de repos restent couvertes de déchets après les périodes de forte fréquentation.",
    whyItMatters: "Le canal est un corridor naturel et un lieu de promenade quotidien qui mérite un entretien régulier.",
    whoIsAffected: "Les riverains, les cyclistes, les promeneurs, les familles et la faune du canal.",
    latestUpdate: "Le signalement reste ouvert. Un renforcement régulier de la collecte n'est pas encore confirmé.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
    observedOn: '2026-08-08',
  ...
  },
  {
    ...
    summary: "Trois points lumineux ne fonctionnent plus sur le parcours entre les logements et la station.",
    description: "Le cheminement piéton menant à la station Reynerie comporte plusieurs zones sans éclairage après la tombée de la nuit.",
    whyItMatters: "Ce trajet quotidien doit rester lisible et sûr pour les habitants qui utilisent les transports en commun.",
    whoIsAffected: "Les habitants du Mirail, les étudiants, les travailleurs du soir et les usagers du métro.",
    latestUpdate: "La panne a été signalée localement. Le rétablissement complet n'est pas encore confirmé.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
    observedOn: '2026-08-08',
  ...
  },
  {
    ...
    description: "Le balisage du chantier laisse un passage piéton étroit et discontinu sur une partie de la rue de la République.",
    whyItMatters: "Un chantier doit maintenir un itinéraire accessible afin que la vie quotidienne du quartier puisse continuer.",
    whoIsAffected: "Les personnes à mobilité réduite, les parents avec poussette, les commerçants et les piétons.",
    latestUpdate: "Le signalement reste ouvert dans l'attente d'un cheminement provisoire accessible.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote: "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
    observedOn: '2026-08-08',
  ...
  },
  {
    ...
    summary: "A repedt és egyenetlen burkolat miatt a gyalogosok gyakran az úttest szélére kényszerülnek.",
    description: "A Wesselényi utca egyik forgalmas szakaszán több járdalap megsüllyedt, és esőben víz gyűlik össze a mélyedésekben.",
    whyItMatters: "A biztonságos járda alapvető feltétele annak, hogy a sűrűn lakott városrész mindenki számára használható legyen.",
    whoIsAffected: "Az idősek, a mozgáskorlátozottak, a babakocsival közlekedő családok és a gyalogosok.",
    ...
    statusNote: "A „megfigyelve” azt jelenti, hogy a helyi közösség felismerte a helyzetet. Nem jelent hivatalos eljárást vagy már megkezdett beavatkozást.",
  ...
  },
  {
    ...
    description: "A vasútállomáshoz vezető gyalogos-aluljáróban több világítótest napok óta nem működik.",
    whyItMatters: "Az aluljáró fontos napi kapcsolat a vasút, a metró és a lakónegyed között; a megfelelő világítás a biztonság része.",
  ...
  },
  {
    ...
    description: "A Római-part több pihenőhelyén a hétvégi forgalom után rendszeresen túlcsordulnak a hulladékgyűjtők.",
    whyItMatters: "A Duna-part közös természeti és rekreációs tér; tisztasága a környezetet és a közösségi használatot is védi.",
  ...
  },
  {
    ...
    description: "A belvárosi Tisza-part egyik szakaszán a kerékpárút burkolata több helyen felrepedt és megsüllyedt.",
    whyItMatters: "A folyóparti útvonal fontos napi és szabadidős kapcsolat; a hibás burkolat balesetveszélyt jelent.",
  ...
  },
  {
    ...
    description: "A tarjáni gyalogos sétányon egymást követő több világítótest nem működik, ezért hosszabb sötét szakasz alakult ki.",
    whyItMatters: "A sétány mindennapi útvonal iskola, üzletek és otthonok között; a világítás a biztonság alapfeltétele.",
  ...
  },
  {
    ...
    summary: "A sérült szegély és a nagy szintkülönbség akadályozza a biztonságos fel- és leszállást.",
    description: "A Széchenyi téri megálló egyik peremén a burkolat sérült, és több ponton egyenetlen a beszállási felület.",
    whyItMatters: "A közösségi közlekedésnek önállóan és biztonságosan használhatónak kell lennie minden utas számára.",
    whoIsAffected: "A mozgáskorlátozott utasok, az idősek, a babakocsival utazók és a villamost használók.",
