...
export const FOUNDATION_SIGNALS = [
  ...
  },
  {
    ...
    statusLabel:
      "Bürgerlicher Status: beobachtet — wartet auf lokale Aufmerksamkeit",
    statusNote:
  ...
  },
  {
    ...
    area: "Zorilor",
    headline:
      "Spațiul verde din Parcul Rozelor, năpădit de vegetație necontrolată",
    summary:
  ...
  },
  {
    ...
    area: "Piața Mică",
    headline:
      "Pavajul istoric din Piața Mică s-a deplasat lângă Pasajul Scărilor",
    summary:
  ...
  },
  {
    ...
    area: "Hipodrom",
    headline:
      "Stâlpii de iluminat din cartierul Hipodrom III rămân stinși de trei săptămâni",
    summary:
  ...
  },
  {
    ...
    headline:
      "Cărările din Pădurea Dumbrava, blocate de crengi căzute după furtuna din iulie",
    summary:
  ...
  },
  {
    ...
    area: "Tătărași",
    headline:
      "Asfaltul de pe strada Moara de Vânt s-a surpat pe o porțiune de zece metri",
    summary:
  ...
  },
  {
    ...
    area: "Nicolina",
    headline:
      "Malul Bahluiului din Nicolina, acoperit de deșeuri aduse de apele mari",
    summary:
  ...
  },
  {
    ...
    area: "Iosefin",
    headline:
      "Trotuarul din fața Gării de Nord rămâne blocat de biciclete abandonate",
    summary:
  ...
  },
  {
    ...
    area: "Pădurea Verde",
    headline:
      "Zona de picnic din Pădurea Verde rămâne fără coșuri de gunoi funcționale",
    summary:
  ...
  },
  {
    ...
    area: "Deutz",
    headline:
      "Die Baustelle an der Deutzer Brücke lässt kaum Platz für Fußgänger",
    summary:
  ...
  },
  {
    ...
    area: "Kreuzviertel",
    headline:
      "Der Gehweg in der Vinckestraße ist durch Baumwurzeln stark angehoben",
    summary:
  ...
  },
  {
    ...
    headline:
      "Die Umleitung an der Münsterstraße ist für Radfahrer nicht ausgeschildert",
    summary:
  ...
  },
  {
    ...
    area: "Bad Cannstatt",
    headline:
      "Der Spielplatz am Kursaal ist seit dem Sturm im Juli halb gesperrt",
    summary:
  ...
  },
  {
    ...
    area: "Ostheim",
    headline:
      "Die Fußgängerunterführung an der Schwarenbergstraße bleibt dunkel",
    summary:
  ...
  },
  {
    ...
    area: "Vaihingen",
    headline:
      "Die Baustelle an der Universität engt den Rad- und Fußweg stark ein",
    summary:
  ...
  },
  {
    ...
    area: "Bornheim",
    headline:
      "Der Gehweg in der Berger Straße ist durch lose Pflastersteine uneben",
    summary:
  ...
  },
  {
    ...
    area: "Gallus",
    headline:
      "Der Weg entlang der Bahngleise im Gallus bleibt abends unbeleuchtet",
    summary:
  ...
  },
  {
    ...
    area: "Sachsenhausen",
    headline:
      "Die Baustelle am Mainufer versperrt den Uferweg ohne Hinweisschilder",
    summary:
  ...
  },
  {
    ...
    area: "Altstadt",
    headline:
      "Das Kopfsteinpflaster in der Getreidegasse ist an mehreren Stellen abgesackt",
    summary:
  ...
  },
  {
    ...
    area: "Lehen",
    headline:
      "Die Unterführung bei der Bahnhaltestelle Lehen bleibt seit Tagen dunkel",
    summary:
  ...
  },
  {
    ...
    area: "Parsch",
    headline:
      "Die Baustelle am Kapuzinerberg-Zugang lässt keinen sicheren Fußweg frei",
    summary:
  ...
  },
  {
    ...
    area: "Vieux-Port",
    headline:
      "Le revêtement piéton du quai des Belges reste dangereux par endroits",
    summary:
      "Plusieurs dalles descellées créent des ressauts sur un passage très fréquenté.",
    description:
  ...
  },
  {
    ...
    area: "Noailles",
    headline:
      "Plusieurs lampadaires restent éteints autour de la place des Capucines",
    summary:
    ...
    latestUpdate:
      "Les habitants indiquent avoir signalé la panne. Le suivi local reste ouvert.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote:
      "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
  ...
  },
  {
    ...
    area: "Pointe-Rouge",
    headline:
      "Des déchets s'accumulent près de l'accès public à la plage de la Pointe-Rouge",
    summary:
      "Des sacs et emballages restent autour des conteneurs pleins après les week-ends.",
    description:
    ...
    latestUpdate:
      "Le signalement reste ouvert dans l'attente d'un passage de collecte renforcé.",
    statusLabel: "Statut civique : observé — en attente d’une attention locale",
    statusNote:
      "« Observé » signifie que la communauté locale a reconnu la situation. Cela ne confirme ni procédure officielle ni intervention déjà engagée.",
    observedLabel: "Observé cette semaine",
  ...
  },
  {
    ...
    area: "Part-Dieu",
    headline:
      "La piste cyclable du boulevard Vivier-Merle est interrompue par le chantier",
    summary:
      "Les cyclistes sont renvoyés brusquement dans la circulation sans itinéraire continu.",
    description:
  ...
  },
  {
    ...
    area: "Guillotière",
    headline:
      "La place Gabriel-Péri manque d'ombre aux heures les plus chaudes",
    summary:
      "Les zones d'attente restent entièrement exposées au soleil durant l'après-midi.",
    description:
  ...
  },
  {
    ...
    area: "Vieux Lyon",
    headline:
      "L'accès au quai de Saône reste difficile pour les fauteuils roulants",
    summary:
      "Une rampe présente une pente forte et un revêtement dégradé près du pont Bonaparte.",
    description:
  ...
  },
  {
    ...
    area: "Canal du Midi",
    headline:
      "Les berges du canal du Midi sont encombrées de déchets après le week-end",
    summary:
      "Des emballages et bouteilles restent sur les pelouses et près de la piste cyclable.",
    description:
  ...
  },
  {
    ...
    area: "Saint-Cyprien",
    headline:
      "Le chantier de la rue de la République réduit le trottoir sans passage accessible",
    summary:
      "Le couloir provisoire est trop étroit pour un fauteuil roulant ou une poussette.",
    description:
  ...
  },
  {
    ...
    latestUpdate:
      "A jelzés helyi és nyitott. Javítási időpontot még nem erősítettek meg.",
  ...
  },
  {
    ...
    whoIsAffected:
      "Az ingázók, a környék lakói, a diákok és az esti közlekedők.",
    latestUpdate:
      "A hibát a lakók jelezték. A teljes helyreállítás még nincs megerősítve.",
    statusLabel: "Civil állapot: megfigyelve — helyi figyelemre vár",
    statusNote:
      "A „megfigyelve” azt jelenti, hogy a helyi közösség felismerte a helyzetet. Nem jelent hivatalos eljárást vagy már megkezdett beavatkozást.",
    observedLabel: "Ezen a héten megfigyelve",
  ...
  },
  {
    ...
    summary:
      "A megtelt tárolók körül műanyag csomagolás és palackok gyűlnek össze.",
    description:
    ...
    whoIsAffected:
      "A helyi lakók, a kerékpárosok, a futók, a családok és a folyópart élővilága.",
    latestUpdate:
      "A jelzés nyitott, rendszeresebb hétvégi elszállítás még nincs megerősítve.",
    statusLabel: "Civil állapot: megfigyelve — helyi figyelemre vár",
    statusNote:
      "A „megfigyelve” azt jelenti, hogy a helyi közösség felismerte a helyzetet. Nem jelent hivatalos eljárást vagy már megkezdett beavatkozást.",
    observedLabel: "Ezen a héten megfigyelve",
  ...
  },
  {
    ...
    summary:
      "A hosszanti repedések és kátyúk kikerülésre kényszerítik a kerékpárosokat.",
    description:
    ...
    whoIsAffected:
      "A kerékpárosok, a rolleresek, a futók és a Tisza-partot használó családok.",
    latestUpdate:
      "A jelzés helyi és nyitott. Javítási ütemezés még nem ismert.",
    statusLabel: "Civil állapot: megfigyelve — helyi figyelemre vár",
    statusNote:
      "A „megfigyelve” azt jelenti, hogy a helyi közösség felismerte a helyzetet. Nem jelent hivatalos eljárást vagy már megkezdett beavatkozást.",
    observedLabel: "Ezen a héten megfigyelve",
  ...
  },
  {
    ...
    whoIsAffected:
      "A tarjáni lakók, az iskolások, az idősek és az esti gyalogosok.",
    latestUpdate:
      "A meghibásodást helyben jelezték. A javítás befejezése még nincs megerősítve.",
    statusLabel: "Civil állapot: megfigyelve — helyi figyelemre vár",
    statusNote:
      "A „megfigyelve” azt jelenti, hogy a helyi közösség felismerte a helyzetet. Nem jelent hivatalos eljárást vagy már megkezdett beavatkozást.",
    observedLabel: "Ezen a héten megfigyelve",
  ...
  },
  {
    ...
    latestUpdate:
      "A jelzés nyitott, az akadálymentes javítás időpontja még nem ismert.",
    statusLabel: "Civil állapot: megfigyelve — helyi figyelemre vár",
    statusNote:
      "A „megfigyelve” azt jelenti, hogy a helyi közösség felismerte a helyzetet. Nem jelent hivatalos eljárást vagy már megkezdett beavatkozást.",
    observedLabel: "Ezen a héten megfigyelve",
